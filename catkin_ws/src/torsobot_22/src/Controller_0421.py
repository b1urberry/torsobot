...
angle_desired = 10.0 # desired angle - 0
k_p_angle = 22.0#10 # propotional gain for angle control
k_i_angle = 15.0#k_p_angle/6. # integral gain for angle control
k_d_angle = 0.0# derivatibe gain for angle control
