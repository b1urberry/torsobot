...
angle_desired = 15.0 # desired angle - 0
k_p_angle = 20.0#10 # propotional gain for angle control (20)
k_i_angle = 13.0#k_p_angle/6. # integral gain for angle control (12/13)
k_d_angle = 0.3# derivatibe gain for angle control 0.5 (0.3/1)
k_p_speed = 20.0#15#1.5 # proportional gain for speed control (60) 1:15
k_i_speed = 15.0#1.5 # integral gain for speed control(30) 1:35
...
#speed_desired2 = 0.5
#angle_desired2 = 0.0
#k_p_angle2 = 12.#10 # propotional gain for angle control //
#k_i_angle2 = 14.#1.5#k_p_angle/6. # integral gain for angle control
#k_d_angle2 = 0.2# derivatibe gain for angle control
#
#k_p_speed2 = 6.#1.5 # proportional gain for speed control (60) 1:15
#k_i_speed2 = 8.#1.5 # integral gain for speed control(30) 1:35
#
...
#        First_PID_run = True
    ...
    if abs(current_imu_angle) <= 60.0 :
        ...
        df = df.append({'Time': time_current-start_time, 'Angle': current_imu_angle}, ignore_index=True)
        draw(df)
    ...
    print(motor_output, current_imu_angle)
    


def draw(df):
    fig, ax = plt.subplots(dpi=120)
    df.plot(kind='line',y='Angle',x='Time', color='red', ax=ax)
