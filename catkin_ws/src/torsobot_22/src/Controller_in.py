...
k_d_angle = 0.5# derivatibe gain for angle control
...
def initialize_file():
    ...
    while not gotname: # keep interating until a unique file name is found
        ...
        if os.path.exists('/home/pi/catkin_ws/src/torsobot_22/src/Log/'+name_temp): # if file name already exists, add 1 to file number
            num += 1
        else:
            filename = name_temp
            gotname = True
